...
/datum/gear/utility/tts_device
	...
	cost = 1 //Not extremely expensive, but it's useful for mute chracters.
...
/datum/gear/utility/wheelchair
	...
	cost = 0	//Seriously, what is it with the differently abled people targeting.
