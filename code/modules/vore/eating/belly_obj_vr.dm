...
/obj/belly
	...
	desc = "Warm, wet, and slimy it's a belly and you've found yourself in it!"	// Flavor text description of inside sight/sound/smells/feels.
	...
	var/escapechance = 25 					// % Chance of prey beginning to escape if prey struggles.
	var/escape_stun = 5						// AI controlled mobs with a number here will be weakened by the provided var when someone escapes, to prevent endless nom loops
